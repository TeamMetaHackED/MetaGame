...
def main():
    ...
    # initialize classes
    npcList = []
    npcList.append(NPC(200, 200, 0, DISPLAYSURF, RED, 'Kevin', 'There''s nobody over here...', 1))#kevin
    ...
    npcList.append(NPC(1100, 1500, 3, DISPLAYSURF, RED, 'Ian', '3 meta 5 me', 1))#Meta
    ...
    Coins.append(Item(1200, 1475, DISPLAYSURF, YELLOW, "money"))
